...
def plot_heatmaps(df, name, plotpath):
  ...
  if "close" in name:
    plot_title = "FTSEMIB daily closing price similarity"
  elif "open" in name:
    plot_title = "FTSEMIB daily opening price similarity"
  elif "conv" in name:
    plot_title = "FTSEMIB convergence model"
  elif "div" in name:
    plot_title = "FTSEMIB divergence model"
  elif "behave_nn" in name:
    plot_title = "FTSEMIB nearest neighbours model"
  elif "punctuacted_china" in name:
    plot_title = "FTSEMIB punctuated (original) at China model"
  elif "punctuacted_who" in name:
    plot_title = "FTSEMIB punctuated (original) at WHO model"
  elif "punctuacted_usa" in name:
    plot_title = "FTSEMIB punctuated (original) at USA model"
  elif "punctuated_nn_china" in name:
    plot_title = "FTSEMIB punctuated (revised) at China model"
  elif "punctuated_nn_who" in name:
    plot_title = "FTSEMIB punctuated (revised) at WHO model"
  elif "punctuated_nn_usa" in name:
    plot_title = "FTSEMIB punctuated (revised) at USA model"
  else:
...
plotpath = "/Users/scrockford/Library/CloudStorage/OneDrive-FondazioneIstitutoItalianoTecnologia/punctuated_similarity_proof/plots/FTSEMIB"
