...
def plot_heatmaps(df, name, plotpath):
  ...
  if "rural" in name:
    plot_title = "Rural girls height similarity"
  elif "urban" in name:
    plot_title = "Urban girls height similarity"
  elif "conv" in name:
    plot_title = "Girls convergence model"
  elif "div" in name:
    plot_title = "Girls divergence model"
  elif "behave_nn" in name:
    plot_title = "Girls nearest neighbours model"
  elif "punctuacted_9" in name:
    plot_title = "Girls punctuated (original) at age 9 model"
  elif "punctuacted_10" in name:
    plot_title = "Girls punctuated (original) at age 10 model"
  elif "punctuacted_11" in name:
    plot_title = "Girls punctuated (original) at age 11 model"
  elif "punctuacted_12" in name:
    plot_title = "Girls punctuated (original) at age 12 model"
  elif "punctuated_nn_9" in name:
    plot_title = "Girls punctuated (revised) at age 9 model"
  elif "punctuated_nn_10" in name:
    plot_title = "Girls punctuated (revised) at age 10 model"
  elif "punctuated_nn_11" in name:
    plot_title = "Girls punctuated (revised) at age 11 model"
  elif "punctuated_nn_12" in name:
    plot_title = "Girls punctuated (revised) at age 12 model"
  else:
...
plotpath = "/Users/scrockford/Library/CloudStorage/OneDrive-FondazioneIstitutoItalianoTecnologia/punctuated_similarity_test/plots/girls"
